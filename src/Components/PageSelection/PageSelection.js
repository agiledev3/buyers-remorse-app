...
const PageSelection = (props) => {
    ...
    return (
        <Fragment>
            {selectedPage === Pages.HOME && <Home allProducts={props.allProducts} changePage={setSelectedPage} updateProduct={props.updateProduct} setCurrentProduct={props.setCurrentProduct} /> }
